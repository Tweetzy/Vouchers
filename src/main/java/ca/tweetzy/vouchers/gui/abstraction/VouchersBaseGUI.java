...
public abstract class VouchersBaseGUI extends BaseGUI {
	...
	public VouchersBaseGUI(Gui parent, @NonNull String title, int rows) {
		super(parent, title, rows);
	}

	public VouchersBaseGUI(Gui parent, @NonNull String title) {
		super(parent, title);
	}

	public VouchersBaseGUI(@NonNull String title) {
		super(title);
	}
